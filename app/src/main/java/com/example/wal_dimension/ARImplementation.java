...
//
//public class ARImplementation extends AppCompatActivity implements Node.OnTapListener, Scene.OnUpdateListener{
//    private static final String TAG = ARImplementation.class.getSimpleName();
